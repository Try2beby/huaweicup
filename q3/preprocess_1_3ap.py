...
df_3ap = pd.read_csv("../data/test_set_1_3ap.csv")
...
print(df_3ap[("mcs_nss", "_")].value_counts(), len(df_3ap[("mcs_nss", "_")].unique()))
...
# save
df_3ap.to_csv("./df_1_3ap_test_final.csv", index=False)
